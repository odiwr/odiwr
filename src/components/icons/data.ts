...
export type IconName = "material-symbols:add-rounded" | "material-symbols:archive-outline-rounded" | "material-symbols:arrow-left-alt-rounded" | "material-symbols:arrow-outward-rounded" | "material-symbols:arrow-right-alt-rounded" | "material-symbols:calendar-month-rounded" | "material-symbols:check-rounded" | "material-symbols:chevron-right-rounded" | "material-symbols:close-rounded" | "material-symbols:colorize-outline-rounded" | "material-symbols:drag-indicator" | "material-symbols:folder-open-rounded" | "material-symbols:folder-rounded" | "material-symbols:ios-share-rounded" | "material-symbols:keep" | "material-symbols:keep-outline" | "material-symbols:pause-rounded" | "material-symbols:play-arrow-rounded" | "material-symbols:skip-next-rounded" | "material-symbols:skip-previous-rounded" | "material-symbols:unarchive-outline-rounded" | "material-symbols:upload-rounded" | "material-symbols:warning-rounded" | "simple-icons:github" | "simple-icons:gmail" | "simple-icons:instagram" | "simple-icons:linkedin" | "simple-icons:rust";
...
export const ICONS: Record<IconName, { body: string; width: number; height: number }> = {
  ...
  "material-symbols:archive-outline-rounded": {
    "body": "<path fill=\"currentColor\" d=\"M11.288 10.288Q11 10.575 11 11v3.2l-.9-.9q-.275-.275-.7-.275t-.7.275t-.275.7t.275.7l2.6 2.6q.3.3.7.3t.7-.3l2.6-2.6q.275-.275.275-.7t-.275-.7t-.7-.275t-.7.275l-.9.9V11q0-.425-.288-.712T12 10t-.712.288M5 8v11h14V8zm0 13q-.825 0-1.412-.587T3 19V6.525q0-.35.113-.675t.337-.6L4.7 3.725q.275-.35.687-.538T6.25 3h11.5q.45 0 .863.188t.687.537l1.25 1.525q.225.275.338.6t.112.675V19q0 .825-.587 1.413T19 21zm.4-15h13.2l-.85-1H6.25zm6.6 7.5\"/>",
    "width": 24,
    "height": 24
  },
  ...
  "material-symbols:ios-share-rounded": {
    "body": "<path fill=\"currentColor\" d=\"M6 22q-.825 0-1.412-.587T4 20V10q0-.825.588-1.412T6 8h2q.425 0 .713.288T9 9t-.288.713T8 10H6v10h12V10h-2q-.425 0-.712-.288T15 9t.288-.712T16 8h2q.825 0 1.413.588T20 10v10q0 .825-.587 1.413T18 22zm5.288-6.288Q11 15.425 11 15V4.825l-.9.9q-.3.3-.7.288T8.7 5.7q-.275-.3-.287-.7t.287-.7l2.6-2.6q.15-.15.325-.212T12 1.425t.375.063t.325.212l2.6 2.6q.275.275.275.688T15.3 5.7q-.3.3-.712.3t-.713-.3L13 4.825V15q0 .425-.288.713T12 16t-.712-.288\"/>",
    "width": 24,
    "height": 24
  },
  ...
  "material-symbols:unarchive-outline-rounded": {
    "body": "<path fill=\"currentColor\" d=\"M12.713 17.388Q13 17.1 13 16.675v-3.2l.9.9q.275.275.7.275t.7-.275t.275-.7t-.275-.7L12.7 10.4q-.3-.3-.7-.3t-.7.3l-2.6 2.575q-.275.275-.275.7t.275.7t.7.275t.7-.275l.9-.9v3.2q0 .425.288.713t.712.287t.713-.288M5 8v11h14V8zm0 13q-.825 0-1.412-.587T3 19V6.525q0-.35.113-.675t.337-.6L4.7 3.725q.275-.35.687-.538T6.25 3h11.5q.45 0 .863.188t.687.537l1.25 1.525q.225.275.338.6t.112.675V19q0 .825-.587 1.413T19 21zm.4-15h13.2l-.85-1H6.25zm6.6 7.5\"/>",
    "width": 24,
    "height": 24
  },
